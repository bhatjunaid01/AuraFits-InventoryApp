...
export const db = {
  ...
  updateBalance: (saleId, amountPaid, balance) => call("update_balance", { saleId: Number(saleId), amountPaid: Number(amountPaid), balance: Number(balance) }),
  getPersonalExpenses: () => call("get_personal_expenses"),
  addPersonalExpense: (expense) => call("add_personal_expense", { expense }),
  updatePersonalExpense: (expense) => call("update_personal_expense", { expense }),
  deletePersonalExpense: (id) => call("delete_personal_expense", { id }),
};
